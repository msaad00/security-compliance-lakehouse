...
| #8 Real evidence connectors                 | Partial | 2     | PR #62 added a GitHub governance sync path; broader runner/source coverage remains.  | Fixture runner tests, credential-boundary docs, normalized connector output.                           |
...
- [ ] #8: connector runner framework and remaining source runners.
